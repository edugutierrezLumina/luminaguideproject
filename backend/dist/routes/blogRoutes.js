...
import { createBlogPost, getAllBlogPosts, getPublishedBlogPosts, getBlogPostById, updateBlogPost, deleteBlogPost } from '../controllers/blogController';
import { authenticate } from '../middleware/auth';
import { authorize } from '../middleware/authorize';
import { upload } from '../middleware/upload';
const router = express.Router();
router.get('/published', getPublishedBlogPosts);
router.get('/published/:id', getBlogPostById);
